...
<body>
    <div class=" header fs-12 text-dark">
        ...
        <div class="menu-mobi bg-green d-block d-lg-none">
            <ul class="d-flex align-items-center justify-content-center">
                ...
                <li class="text-center fs-30 w-25"><a href="#" class="d-inline-flex py-3 px-2 w-100 text-white align-items-center justify-content-center position-relative">Icon giỏ hàng</a></li>
                <li class="text-center fs-30 w-25"><a href="#" class="d-inline-flex py-3 px-2 w-100 text-white align-items-center justify-content-center position-relative">Icon tìm kiếm</a></li>
            </ul>
         </div>
    </div>
    <!-- ===Mobile Menu===== -->
    <div class="modal" id="modal">
        <div class="modal-content">
            <button class="close-btn" onclick="toggleModal(false)">X</button>
            Nội dung modal lớn
        </div>
    </div>
